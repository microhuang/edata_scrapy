...
#        print(22222222222)
    if fullname in self.hook_modules.keys():
      return MetaPathLoader(self.hook_modules)
...
#    print(1111111,  module, _hook_modules[fullname][0],  module, _hook_modules[fullname][1])
    module_hook(self.hook_modules, fullname, module, self.hook_modules[fullname][0], self.hook_modules[fullname][1])
    sys.meta_path.insert(0, finder)
    return module
  
def _hook(hook_modules):
    sys.meta_path.insert(0, MetaPathFinder(hook_modules))
  
def module_hook(_hook_modules, fullname, module, func, wrapper):
