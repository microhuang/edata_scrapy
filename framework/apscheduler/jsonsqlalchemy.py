...
class JsonSQLAlchemyJobStore(SQLAlchemyJobStore):
    def __init__(self, url=None, engine=None, tablename='apscheduler_jobs', metadata=None,
                 pickle_protocol=HIGHEST_PROTOCOL, tableschema=None, engine_options=None):
...
class SQLAlchemyJobStore(BaseJobStore):
    ...
    warnings.warn('SQLAlchemyJobStore has been deprecated, use JsonSQLAlchemyJobStore instead.', DeprecationWarning)
